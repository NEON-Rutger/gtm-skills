...
A tuned advocate's drafts are indistinguishable from the person's own comments — same rhythm, same hedging, same disclosure habits — and factually current. The overlooked failure: tuning voice once and never refreshing the knowledge base, so drafts sound right but describe last quarter's product. Success: the reviewer approves drafts with fewer and fewer edits over time.

MUST review and edit extracted voice guidelines rather than trusting extraction blindly. MUST refresh the knowledge base after major product changes. NEVER pad the knowledge base with content that doesn't help answer a buyer's thread.
